...
public class AdminRealm extends AuthorizingRealm {
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
        ...
        authorizationInfo.setRoles(adminService.queryRoles(username));
        authorizationInfo.setStringPermissions(adminService.queryJurisdiction(username));
