...
<div class="bodywrapper">
    ...
    <div class="centercontent">
        ...
        <div class="pageheader">
            <h1 class="pagetitle">期中测试试卷</h1>
            <span class="pagedesc">The content below are loaded using inline data</span>
            
            <ul class="hornav">
                <li class="current"><a href="#basicform">期中测试试卷列表</a></li>
                <li><a href="#validation">期中测试试卷添加</a></li>
            </ul>
        </div><!--pageheader-->
                        ...
                        <div class="widgetbox">
                            ...
                            <div class="widgetcontent padding0 statement">
                               <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                                    ...
                                    <thead>
                                        <tr>
                                            <th class="head0">期中测试试卷id</th>
                                            <th class="head1">期中测试试卷名称</th>
            ...
            <div id="validation" class="subcontent" style="display: none">
                   <form class="stdform" action="" method="post">
                        ...
                        <p>
                        	<label>章节</label>
                        <span class="formwrapper">
                                <select data-placeholder="选择章节..." class="chzn-select" multiple="multiple" style="width:350px;" tabindex="4">
