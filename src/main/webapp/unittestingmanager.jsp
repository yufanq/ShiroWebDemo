...
<div class="bodywrapper">
    ...
    <div class="centercontent">
        ...
        <div class="pageheader">
            <h1 class="pagetitle">单元测试试卷</h1>
            <span class="pagedesc">The content below are loaded using inline data</span>
            
            <ul class="hornav">
                <li class="current"><a href="#basicform">单元测试试卷列表</a></li>
                <li><a href="#validation">单元测试试卷添加</a></li>
            </ul>
        </div><!--pageheader-->
                        ...
                        <div class="widgetbox">
                            ...
                            <div class="widgetcontent padding0 statement">
                               <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                                    ...
                                    <thead>
                                        <tr>
                                            <th class="head0">单元测试试卷id</th>
                                            <th class="head1">单元测试试卷名称</th>
